#pragma checksum "C:\Projetos\RelacionaW3-2020\relacionaw3-refatorado\relacionaw3.mvc\Views\CoreUI\buttons-buttons.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ca83bf3207896eefac60a63215a68568d94ad2a8"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ca83bf3207896eefac60a63215a68568d94ad2a8", @"/Views/CoreUI/buttons-buttons.cshtml")]
  ...
  <div class=""card-body"">
    ...
    <div class=""row align-items-center mt-3"">
      ...
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
        <button type=""b");
            WriteLiteral(@"utton"" class=""btn btn-block btn-secondary active"" aria-pressed=""true"">Secondary</button>
      </div>
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
      ...
      <di");
            WriteLiteral(@"v class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
...
<div class=""card"">
  <div class=""card-header"">
    <str");
            WriteLiteral(@"ong>Outline Buttons</strong>
  </div>
  <div class=""card-body"">
    <p>
      Use
    ...
    <div class=""row align-items-center"">
      ...
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
        <button type=""bu");
            WriteLiteral(@"tton"" class=""btn btn-block btn-outline-danger"">Danger</button>
      </div>
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
    ...
    <div class=""row align-items-center mt-3"">
      ...
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
 ");
            WriteLiteral(@"       <button type=""button"" class=""btn btn-block btn-outline-secondary active"" aria-pressed=""true"">Secondary</button>
      </div>
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
      ...
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
        <button type=""button"" class=""btn btn-block btn-outline-l");
            WriteLiteral(@"ight active"" aria-pressed=""true"">Light</button>
      </div>
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
...
<div class=""card"">
  ...
  <div class=""card-bod");
    ...
    <div class=""row align-items-center mt-3"">
      ...
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
        <button type=""button"" class=""btn btn-block btn-ghost-secondary active"" aria");
            WriteLiteral(@"-pressed=""true"">Secondary</button>
      </div>
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
      ...
      <div class=""col-6 col-sm-4 ");
            WriteLiteral(@"col-md-2 col-xl mb-3 mb-xl-0"">
    ...
    <div class=""row align-items-center mt-3"">
      ...
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
        <button type=""button"" class=""btn btn-block btn-ghost-warning"" disabled>Wa");
            WriteLiteral(@"rning</button>
      </div>
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
...
<div class=""card"">
  ...
  <div class=""card-body"">
    ...
    <div class=""row ali");
      ...
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
        <button type");
            WriteLiteral(@"=""button"" class=""btn btn-square btn-block btn-info"">Info</button>
      </div>
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
    ...
    <div class=""row align-items-center mt-3"">
      ...
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
        <button type=""button"" class=""btn btn-square btn-");
            WriteLiteral(@"block btn-secondary active"" aria-pressed=""true"">Secondary</button>
      </div>
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
      ...
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
        <button type=""button"" class=""btn btn-square btn-block btn-light active"" aria-pressed=""true"">Ligh");
    ...
    <div class=""row align-items-center mt-3"">
      ...
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
        <button type=""button"" class=""btn btn-square btn-block ");
            WriteLiteral(@"btn-success"" disabled>Success</button>
      </div>
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
      ...
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
        <button type=""button"" class=");
            WriteLiteral(@"""btn btn-square btn-block btn-link"" disabled>Link</button>
      </div>
    </div>
  </div>
</div>
<div class=""card"">
  ...
  <div class=""card-body"">
    ...
    <div class=""row align-items-center"">
      ...
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
        <button type=""button"" class=""btn btn");
            WriteLiteral(@"-pill btn-block btn-warning"">Warning</button>
      </div>
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
    ...
    <div class=""row align-items-center mt-3"">
      ...
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
    ");
            WriteLiteral(@"    <button type=""button"" class=""btn btn-pill btn-block btn-info active"" aria-pressed=""true"">Info</button>
      </div>
      <div class=""col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
    ...
    <div class=""row align-items-center mt-3"">
      ...
      <div class=""col-6 col-");
            WriteLiteral(@"sm-4 col-md-2 col-xl mb-3 mb-xl-0"">
...
<div class=""card"">
  ...
  <div class=""card-body"">
    ...
    <div class=""row align-items-center"">
      ...
      <div class=""col-6 col-sm-4 col-md mb-3 mb-xl-0 text-center"">
        <button type=""button"" cl");
            WriteLiteral(@"ass=""btn btn-sm btn-outline-secondary"">Outline Button</button>
      </div>
      <div class=""col-6 col-sm-4 col-md mb-3 mb-xl-0 text-center"">
    ...
    <div class=""row align-items-center mt-3"">
      ...
      <div class=""col-6 col-sm-4 col-md mb-3 mb-xl-0 text-center"">
        <button type=""button"" class=""btn btn-outline-secondary"">Outline Butt");
