...
//Users
 ...
 public async Task<User[]> GetAllUserAsync(bool includeAspNetUsers)
        {                                           //se for passado com parametro true vai no IF
          ...
          public async Task<User> GetUserAsyncById(int UserId, bool includeAspNetUsers)
        {
            IQueryable<User> query = _context.Users;
            query = query.AsNoTracking()
...
//Palestrante
        ...
        public void DeleteRange(Lote[] lotes)
        {
