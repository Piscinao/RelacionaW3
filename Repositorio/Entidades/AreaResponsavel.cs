...
//     //    public async new Task<AreaResponsavel> GetAreaById (int IdArea, string IdUsuario)
//     //     {
//     //         return await _contexto.AreaResponsavel.FirstOrDefaultAsync(a => a.IdUsuario == IdUsuario && a.IdArea == IdArea);
//     //     }
